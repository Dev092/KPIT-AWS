...
public class App {
    private static final String SOURCEPATH="D:\\AWSmarathon\\marathonPractice1\\src\\resources\\source";
    private static final String DESTPATH="D:\\AWSmarathon\\marathonPractice1\\src\\resources\\destination";
    private static final String BUCKET_NAME="hithim";
    public static void main(String[] args) {
        
        S3Client client = S3Client.builder().region(Region.US_EAST_1).build();
        upload(client, "New Text Document.txt");
        // upload(client, "solar-system.webp");

        System.out.println("Finding objects in buckets ....");
        List<String> objectKeys = App.getAllObjects(client);
